...
API 列表:
- `flash_attention_inputs_static_tile_dynamic_kernel(q: Memory, k: Memory, v: Memory, out: Memory, br: SymbolDim, bc: SymbolDim) -> None`
- `main() -> None`
...
def flash_attention_inputs_static_tile_dynamic_kernel(
    ...
    使用示例:
    - `flash_attention_inputs_static_tile_dynamic_kernel(q, k, v, out, br, bc)`
    """
