...
使用示例:
- python expectation/dsl/mlir_gen/dialect/dma/load.py
...
def load_kernel(src: f"Tensor[f32, {SOURCE_ROWS}, {SOURCE_COLS}]") -> "Tensor[f32, 1, 1]":
    return load(src, [0, 0], [1, 1], [1, 1], MemorySpace.SM)
