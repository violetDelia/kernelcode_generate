...
功能说明:
- 验证 nn.le 返回 predicate dtype 的 Memory。

使用示例:
- python expectation/operation/nn/le.py
...
from kernel_gen.operation.nn import le
...
with pytest.raises(ValueError):
    le(lhs, Memory([invalid_dim], NumericType.Float32))
