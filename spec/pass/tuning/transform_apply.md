...
- `spec`：[`spec/pass/tuning/transform_apply.md`](transform_apply.md)
...
- 测试文件：`test/passes/tuning/test_transform_apply.py`、`test/passes/test_registry.py`、`test/passes/pipeline/test_npu_demo_lowering.py`
- 执行命令：
  - `PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=. pytest -q test/passes/tuning/test_transform_apply.py`
