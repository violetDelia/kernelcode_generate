...
- `功能实现`：`kernel_gen/passes/arch_parallelize/__init__.py`、`kernel_gen/passes/arch_parallelize/arch_parallelize.py`
- `test`：`test/passes/test_arch_parallelize.py`、`test/passes/test_registry.py`、`test/passes/test_pattern_public_api_docs.py`
