...
| 小李飞刀 | free | 小李飞刀 | codex | 小李飞刀 | 完成 symbol dialect integer-only 复审 | agents/codex-multi-agents/agents/小李飞刀/小李飞刀.prompt.md | agents/codex-multi-agents/agents/小李飞刀 | 负责实现与测试，审查、合并 |
