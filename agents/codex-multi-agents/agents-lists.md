...
| 咯咯咯 | free | 咯咯咯 | codex | 咯咯咯 | 擅长 spec 编写、审查复审与链路闭环核对 | agents/codex-multi-agents/agents/咯咯咯/咯咯咯.prompt.md | agents/codex-multi-agents/agents/咯咯咯 | 负责 spec 文档编写，兼职审查 |
