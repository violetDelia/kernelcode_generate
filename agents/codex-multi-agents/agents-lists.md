...
| 小李飞刀 | free | 小李飞刀 | codex | 小李飞刀 | 复审CPU运行期rank未闭环 | agents/codex-multi-agents/agents/小李飞刀/小李飞刀.prompt.md | agents/codex-multi-agents/agents/小李飞刀 | 负责实现与测试，审查、合并 |
...
| 不要啊教练 | free | 不要啊教练 | codex | 不要啊教练 | 完成DSL P0补测，emit_mlir覆盖79% | agents/codex-multi-agents/agents/不要啊教练/不要啊教练.prompt.md | agents/codex-multi-agents/agents/不要啊教练 | 负责 spec 文档编写、审查、合并 |
