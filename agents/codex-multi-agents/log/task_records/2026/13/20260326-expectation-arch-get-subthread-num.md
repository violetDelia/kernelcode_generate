...
改动: 经办人=我不是牛马；更新 spec/dsl/{ast,emit_mlir,mlir_gen}.md 的 get_subthread_num 规则与编号映射；扩展 kernel_gen/dsl/ast.py 与 kernel_gen/dsl/emit_mlir.py 支持 get_subthread_num 解析与 lowering；新增 test/dsl/test_ast_visitor.py 正反向用例与 emit_mlir 覆盖。
