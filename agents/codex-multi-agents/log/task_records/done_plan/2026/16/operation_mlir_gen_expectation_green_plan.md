...
- `rg -n "out-first|target-first|side-effect op|softmax\\(value\\)|只支持 reduce dim 为一个" ARCHITECTURE/plan/operation_mlir_gen_expectation_green_plan.md spec/dialect/kernel.md spec/dialect/dma.md spec/pass/lowering/nn_lowering.md spec/dsl/mlir_gen.md spec/dsl/gen_kernel.md`

#### 验收必过项目

- `rg -n "out-first|target-first|side-effect op" ARCHITECTURE/plan/operation_mlir_gen_expectation_green_plan.md`
- `rg -n "softmax\\(value\\).*helper|只支持 reduce dim 为一个" ARCHITECTURE/plan/operation_mlir_gen_expectation_green_plan.md spec/pass/lowering/nn_lowering.md`
