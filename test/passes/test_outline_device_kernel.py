...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_pass_registry_name
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_lowering_compat_import_matches_rehome_entry
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_non_module_input_raises_stable_error
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_empty_module_returns_same_object
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_apply_behaves_like_module_pass
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_outlines_single_function
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_rejects_partial_launch_attrs
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_rejects_non_positive_launch_extent
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_rejects_non_int_like_shared_memory_size
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_rejects_negative_shared_memory_size
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_rejects_non_zero_result_function
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
...
# 使用示例: pytest -q test/passes/test_outline_device_kernel.py -k test_outline_device_kernel_rejects_existing_device_name_conflict
# 对应功能实现文件路径: kernel_gen/passes/outline_device_kernel.py
# 对应 spec 文件路径: spec/pass/outline_device_kernel.md
# 对应测试文件路径: test/passes/test_outline_device_kernel.py
