...
# 使用示例: pytest -q test/passes/test_multi_buffer.py -k test_multi_buffer_keeps_free_before_loop_noop
# 对应功能实现文件路径: kernel_gen/passes/multi_buffer.py
# 对应 spec 文件路径: spec/pass/multi_buffer.md
# 对应测试文件路径: test/passes/test_multi_buffer.py
...
# 使用示例: pytest -q test/passes/test_multi_buffer.py -k test_multi_buffer_keeps_loop_internal_alloc_noop
# 对应功能实现文件路径: kernel_gen/passes/multi_buffer.py
# 对应 spec 文件路径: spec/pass/multi_buffer.md
# 对应测试文件路径: test/passes/test_multi_buffer.py
...
# 使用示例: pytest -q test/passes/test_multi_buffer.py -k test_multi_buffer_target_same_space_static_num
# 对应功能实现文件路径: kernel_gen/passes/multi_buffer.py
# 对应 spec 文件路径: spec/pass/multi_buffer.md
# 对应测试文件路径: test/passes/test_multi_buffer.py
...
# 使用示例: pytest -q test/passes/test_multi_buffer.py -k test_multi_buffer_target_different_space_static_num
# 对应功能实现文件路径: kernel_gen/passes/multi_buffer.py
# 对应 spec 文件路径: spec/pass/multi_buffer.md
# 对应测试文件路径: test/passes/test_multi_buffer.py
...
# 使用示例: pytest -q test/passes/test_multi_buffer.py -k test_multi_buffer_target_dynamic_same_space_num
# 对应功能实现文件路径: kernel_gen/passes/multi_buffer.py
# 对应 spec 文件路径: spec/pass/multi_buffer.md
# 对应测试文件路径: test/passes/test_multi_buffer.py
