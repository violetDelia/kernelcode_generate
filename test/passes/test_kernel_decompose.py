...
使用示例:
- pytest -q test/passes/test_kernel_decompose.py

关联文件:
- 功能实现: kernel_gen/passes/kernel_decompose.py
- Spec 文档: spec/pass/kernel_decompose.md
...
def _run_decompose_case(case_name: str, case_text: str) -> str:
    ...
    source_path = f"test/passes/test_kernel_decompose.py#{case_name}"
...
def test_kernel_decompose_static_dynamic_acc_matmul() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k static_dynamic_acc
    """
...
def test_kernel_decompose_dynamic_shape_dynamic_acc_matmul() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k dynamic_shape
    """
...
def test_kernel_decompose_reports_stable_error_for_invalid_fusion_acc() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k invalid_fusion_acc
    """
...
builtin.module {{
  func.func @invalid_acc_case(
    ...
    result = run_ircheck_text(case_text, source_path="test/passes/test_kernel_decompose.py#invalid_acc")
...
def test_kernel_decompose_ignores_fusion_list_metadata() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k ignores_fusion_list
    """
...
def test_kernel_decompose_no_fusion_no_op() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k no_fusion
    """
...
def test_kernel_decompose_removes_zero_fill_before_dynamic_acc_matmul() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k removes_zero_fill
    """
...
def test_kernel_decompose_allows_pure_alias_setup_before_k_loop() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k pure_alias_setup
    """
...
def test_kernel_decompose_keeps_fill_for_alias_write_before_k_loop() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k alias_write_before_k_loop
    """
...
def test_kernel_decompose_keeps_fill_when_loop_body_reads_out_before_fusion() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k reads_out_before_fusion
    """
...
def test_kernel_decompose_rolls_back_fill_removal_when_verify_fails(monkeypatch) -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k rolls_back_fill_removal
    """
...
def test_kernel_decompose_keeps_fill_for_noncanonical_acc() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k noncanonical_acc
    """
...
def test_kernel_decompose_rejects_options() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_decompose.py -k rejects_options
    """
