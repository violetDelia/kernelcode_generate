...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_stages_gm_to_lm_and_writeback
...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_lm_only_is_noop
# 对应功能实现文件路径: kernel_gen/passes/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/lowering/dma_memory_hierarchy/spec.md
# 对应测试文件路径: test/passes/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_window_offsets_and_unit_strides
# 对应功能实现文件路径: kernel_gen/passes/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/lowering/dma_memory_hierarchy/spec.md
# 对应测试文件路径: test/passes/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_symbol_shape_passthrough
# 对应功能实现文件路径: kernel_gen/passes/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/lowering/dma_memory_hierarchy/spec.md
# 对应测试文件路径: test/passes/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_requires_sm_lm
# 对应功能实现文件路径: kernel_gen/passes/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/lowering/dma_memory_hierarchy/spec.md
# 对应测试文件路径: test/passes/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_rejects_anonymous_dynamic_shape
# 对应功能实现文件路径: kernel_gen/passes/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/lowering/dma_memory_hierarchy/spec.md
# 对应测试文件路径: test/passes/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_rejects_nn_ops_in_input
# 对应功能实现文件路径: kernel_gen/passes/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/lowering/dma_memory_hierarchy/spec.md
# 对应测试文件路径: test/passes/test_dma_memory_hierarchy.py
