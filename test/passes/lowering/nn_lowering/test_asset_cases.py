...
功能说明:
- 将 `test/passes/lowering/nn_lowering/` 下仍以资产形态存放的 nn_lowering case 收口为 collectable pytest。
...
- pytest -q test/passes/lowering/nn_lowering
...
- 测试文件: [test/passes/lowering/nn_lowering/test_asset_cases.py](test/passes/lowering/nn_lowering/test_asset_cases.py)
"""
...
from . import test_cast as cast_cases
from . import test_element_binary_add as element_binary_add_cases
from . import test_element_binary_div as element_binary_div_cases
from . import test_element_binary_mul as element_binary_mul_cases
from . import test_element_binary_sub as element_binary_sub_cases
from . import test_element_binary_truediv as element_binary_truediv_cases
from . import test_element_compare_eq as element_compare_eq_cases
from . import test_element_compare_ge as element_compare_ge_cases
from . import test_element_compare_gt as element_compare_gt_cases
from . import test_element_compare_le as element_compare_le_cases
from . import test_element_compare_lt as element_compare_lt_cases
from . import test_element_compare_ne as element_compare_ne_cases
from . import test_exp as exp_cases
from . import test_img2col1d as img2col1d_cases
from . import test_img2col2d as img2col2d_cases
from . import test_matmul as matmul_cases
from . import test_select as select_cases
...
def test_nn_lowering_asset_case(case_name: str, case_fn: Callable[[], None]) -> None:
    ...
    使用示例:
    - pytest -q test/passes/lowering/nn_lowering/test_asset_cases.py -k element_binary_add

    关联文件:
    - spec: [spec/pass/lowering/nn_lowering/spec.md](spec/pass/lowering/nn_lowering/spec.md)
    - test: [test/passes/lowering/nn_lowering/test_asset_cases.py](test/passes/lowering/nn_lowering/test_asset_cases.py)
    - 功能实现: [kernel_gen/passes/lowering/nn_lowering/nn_lowering.py](kernel_gen/passes/lowering/nn_lowering/nn_lowering.py)
    """
