...
- 测试文件: test/passes/lowering/nn_lowering/test_element_compare_eq.py
"""
...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_element_compare_eq.py -k test_lower_eq_mixed_compare_to_kernel_binary_elewise
...
# 对应测试文件路径: test/passes/lowering/nn_lowering/test_element_compare_eq.py
