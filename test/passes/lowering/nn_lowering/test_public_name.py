...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_public_name.py -k test_nn_lowering_pass_public_name
...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_public_name.py -k test_nn_lowering_pass_public_exports
...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_public_name.py -k test_nn_lowering_patterns_compose_public_family_exports
# 对应功能实现文件路径: kernel_gen/passes/lowering/nn_lowering/__init__.py
# 对应 spec 文件路径: spec/pass/lowering/nn_lowering/spec.md
# 对应测试文件路径: test/passes/lowering/nn_lowering/test_public_name.py
...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_public_name.py -k test_nn_lowering_child_pattern_exports
...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_public_name.py -k test_nn_lowering_apply_uses_pattern_driver
# 对应功能实现文件路径: kernel_gen/passes/lowering/nn_lowering/__init__.py
# 对应 spec 文件路径: spec/pass/lowering/nn_lowering/spec.md
# 对应测试文件路径: test/passes/lowering/nn_lowering/test_public_name.py
