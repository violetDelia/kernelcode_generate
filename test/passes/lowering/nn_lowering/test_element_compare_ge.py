"""nn_lowering element compare ge tests.


功能说明:
- 验证 nn.ge lower 为 kernel.binary_elewise(kind="ge")。
...
- 测试文件: test/passes/lowering/nn_lowering/test_element_compare_ge.py
"""
...
# 使用示例: pytest -q test/passes/lowering/nn_lowering/test_element_compare_ge.py -k test_lower_ge_to_kernel_binary_elewise
...
# 对应测试文件路径: test/passes/lowering/nn_lowering/test_element_compare_ge.py
def test_lower_ge_to_kernel_binary_elewise() -> None:
    ...
    assert kernel_ops and kernel_ops[0].kind.data == "ge"
