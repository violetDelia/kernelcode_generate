...
- Spec 文档: spec/pass/kernel_aggregate.md
- 测试文件: test/passes/test_kernel_aggregate.py
"""
...
def _run_kernel_aggregate_case(case_name: str, case_text: str) -> str:
    ...
    source_path = f"test/passes/test_kernel_aggregate.py#{case_name}"
...
def test_kernel_aggregate_fuses_nonzero_start_reduce_owner() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_fuses_nonzero_start_reduce_owner
    """
...
def test_kernel_aggregate_fuses_dynamic_start_reduce_owner() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_fuses_dynamic_start_reduce_owner
    """
...
def test_kernel_aggregate_fuses_nested_k_owner() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_fuses_nested_k_owner
    """
...
def test_kernel_aggregate_fuses_outer_tmp_lifetime_nested_k_owner() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_fuses_outer_tmp_lifetime_nested_k_owner
    """
...
def test_kernel_aggregate_rejects_multiple_k_owner_candidates() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_rejects_multiple_k_owner_candidates
    """
...
def test_kernel_aggregate_rejects_m_or_n_loop_as_acc_owner() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_rejects_m_or_n_loop_as_acc_owner
    """
...
def test_kernel_aggregate_keeps_extra_tmp_use_no_op() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_keeps_extra_tmp_use_no_op
    """
...
def test_kernel_aggregate_matmul_acc_false_no_op() -> None:
    ...
    使用示例:
    - pytest -q test/passes/test_kernel_aggregate.py -k test_kernel_aggregate_matmul_acc_false_no_op
    """
