...
使用示例:
- pytest -q test/passes/tuning/test_dma_memory_hierarchy.py

覆盖率命令:
- pytest --cov=kernel_gen.passes.tuning.dma_memory_hierarchy --cov-report=term-missing test/passes/tuning/test_dma_memory_hierarchy.py

关联文件:
- 功能实现: kernel_gen/passes/tuning/dma_memory_hierarchy.py
- Spec 文档: spec/pass/tuning/dma_memory_hierarchy.md
- 测试文件: test/passes/tuning/test_dma_memory_hierarchy.py
"""
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_default_no_apply_op_is_noop
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_fold_false_legacy_hierarchy
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_apply_op_matmul_copies_lhs_rhs
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_apply_op_can_copy_out
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k all_tlm1
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_apply_op_empty_rule_noop
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_registry_apply_op
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_apply_op_symbol_shape
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_apply_op_accepts_anonymous_dynamic_shape
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
...
# 使用示例: pytest -q test/passes/tuning/test_dma_memory_hierarchy.py -k test_dma_memory_hierarchy_rejects_invalid_apply_op_rules
# 对应功能实现文件路径: kernel_gen/passes/tuning/dma_memory_hierarchy.py
# 对应 spec 文件路径: spec/pass/tuning/dma_memory_hierarchy.md
# 对应测试文件路径: test/passes/tuning/test_dma_memory_hierarchy.py
