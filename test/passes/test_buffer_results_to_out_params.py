...
- 测试文件: test/passes/test_buffer_results_to_out_params.py
"""
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_single_memory_result_to_front_out_param
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_rejects_external_declaration
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_callsite_replaces_old_memory_result_ssa
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_pass_manager_runs_lower_then_buffer_results_to_out_params
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
...
def _assert_pass_manager_runs_lower_then_buffer_results_to_out_params(
    ...
    order: list[str] = []
    original_lower_apply = NnLoweringPass.apply
    original_buffer_apply = BufferResultsToOutParamsPass.apply

    def _record_lower(self: NnLoweringPass, ctx: Context, module: ModuleOp) -> None:
        order.append(self.name)
        return original_lower_apply(self, ctx, module)

    def _record_buffer(self: BufferResultsToOutParamsPass, ctx: Context, module: ModuleOp) -> None:
        order.append(self.name)
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_multiple_memory_results_to_arg0_arg1
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_mixed_memory_and_scalar_results_preserves_scalar_return
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_rejects_multi_block_function
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_rejects_return_arity_mismatch
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_rejects_callsite_signature_mismatch
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_rejects_old_memory_callsite_against_rewritten_callee
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
...
# 使用示例: pytest -q test/passes/test_buffer_results_to_out_params.py -k test_rewrite_rejects_callsite_result_type_mismatch_with_same_arity
# 对应功能实现文件路径: kernel_gen/passes/buffer_results_to_out_params.py
# 对应 spec 文件路径: spec/pass/buffer_results_to_out_params.md
# 对应测试文件路径: test/passes/test_buffer_results_to_out_params.py
