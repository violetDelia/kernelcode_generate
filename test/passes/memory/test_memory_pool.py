...
使用示例:
- pytest -q test/passes/memory/test_memory_pool.py -k "summary or interval or peak"

当前覆盖率信息:
- `kernel_gen.passes.memory.memory_pool`：`未采集`（新增测试，待补充统计）。

覆盖率命令:
- `pytest --cov=kernel_gen.passes.memory.memory_pool --cov-report=term-missing -q test/passes/memory/test_memory_pool.py`

关联文件:
- 功能实现: kernel_gen/passes/memory/memory_pool.py
- Spec 文档: spec/pass/memory/memory_pool.md
- 测试文件: test/passes/memory/test_memory_pool.py
"""
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_summary_basic
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_public_summary_access_edges
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_public_option_matrix
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_summary_uses_alloc_name_hint
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_interval_indices
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_peak_overlap
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k "rewrite and straight_line"
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_multiple_buckets
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_size_mismatch
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_overlap
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_rank_zero_and_rank_one
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_dtype_and_symbolic_shape_matrix
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_preserves_unknown_full_rank_dynamic_shape
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_does_not_infer_following_reshape_layout
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_later_dynamic_shape_uses_own_anchor
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_public_invalid_shape_stride_and_free_edges
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
def test_memory_pool_rewrite_chains_dynamic_aligned_offsets() -> None:
    ...
    使用示例:
    - pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_chains_dynamic_aligned_offsets
    """
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_public_rewrite_error_edges
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_mixed_dtype_rewrite_edges
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_non_alloc_noop
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_multiple_blocks
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_invalid_module
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_non_contiguous_layout
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_unpaired_alloc
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_anonymous_dim
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_alloc_non_memory
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_symbol_for_reuse
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_symbol_for_dynamic_alloc_dominates_later_offset
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_symbol_for_outer_alloc_can_feed_inner_loop
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_scf_for_alloc_uses_function_backing
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# TC-MP-010E
# 功能说明: 验证 ArchParallelizePass block0 guard 形态中的 scf.if branch alloc 可被 memory-pool 改写。
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_scif_branch_alloc_for_block0_guard
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
def test_memory_pool_rewrite_scif_branch_alloc_for_block0_guard() -> None:
...
"""
    result = run_ircheck_text(case_text, source_path="test/passes/memory/test_memory_pool.py")
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_scf_if_without_else_branch_alloc
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_function_arg_dynamic_shape_rewrite
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_loop_local_dynamic_shape_rewrite
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_rewrite_accepts_iter_token_shape_expression
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_escape_return
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_invalid_lifetime_loop
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_unsupported_region_escape
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_pool.py -k test_memory_pool_ircheck_rejects_invalid_alignment_option
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_pool.py
# 对应 spec 文件路径: spec/pass/memory/memory_pool.md
# 对应测试文件路径: test/passes/memory/test_memory_pool.py
...
""",
        source_path="test/passes/memory/test_memory_pool.py#invalid_alignment",
    )
