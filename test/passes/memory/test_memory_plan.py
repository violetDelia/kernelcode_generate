...
- 测试只使用公开 API，不直连 `kernel_gen.passes.memory.memory_plan` 内部 helper。

使用示例:
- pytest -q test/passes/memory/test_memory_plan.py

关联文件:
- 功能实现: kernel_gen/passes/memory/memory_plan.py
- Spec 文档: spec/pass/memory/memory_plan.md
- 测试文件: test/passes/memory/test_memory_plan.py
"""
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_ircheck_inserts_free_for_static_alloc
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_inserts_free_for_dynamic_alloc
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_auto_pad_rewrites_tail_alloc_to_logical_alias
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_auto_pad_redirects_existing_free_to_backing
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_auto_pad_keeps_unknown_shape_noop
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_auto_pad_supports_nonzero_start_tail
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_auto_pad_supports_product_tail_upper_bound
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_auto_pad_supports_min_symbol_upper_bound
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_reuse_rewrites_non_overlapping_allocs
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_reuse_keeps_mismatched_memory_type
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_free_before_last_use
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_free_before_alias_use
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# TC-MPLAN-005
# 功能说明: 验证重复 free 必须失败。
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_multiple_free
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_tracks_view_alias
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_tracks_reshape_alias
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_tracks_subview_alias
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_tracks_reinterpret_alias
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_tracks_deslice_target_alias_not_source
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_nested_symbol_for_places_inner_and_outer_free
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_nested_symbol_for_free_before_later_inner_use
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_nested_symbol_for_free_inside_loop_for_outer_alloc
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_allows_call_operand
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_memory_return_call
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_return_escape
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_scf_for_region
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_inserts_free_inside_scf_if_region
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_inserts_free_after_scf_if_branch_use
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_reuses_same_scf_if_branch_allocs
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_does_not_reuse_across_scf_if_branches
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_scf_if_branch_yield_escape
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
def test_memory_plan_rejects_scf_if_branch_yield_escape() -> None:
    ...
    使用示例:
    - pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_rejects_scf_if_branch_yield_escape
    """
...
# 使用示例: pytest -q test/passes/memory/test_memory_plan.py -k test_memory_plan_disabled_is_noop
# 对应功能实现文件路径: kernel_gen/passes/memory/memory_plan.py
# 对应 spec 文件路径: spec/pass/memory/memory_plan.md
# 对应测试文件路径: test/passes/memory/test_memory_plan.py
