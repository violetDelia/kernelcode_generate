...
使用示例:
- pytest -q test/operation/test_dma_alloc_lifecycle.py

关联文件:
- 功能实现: kernel_gen/operation/dma.py
- Spec 文档: spec/operation/dma.md
- 测试文件: test/operation/test_dma_alloc_lifecycle.py
"""
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_alloc_returns_memory
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_alloc_default_stride_for_symbolic_shape
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_alloc_preserves_format
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_alloc_preserves_explicit_stride
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# TC-OP-DMA-AF-003
# 测试目的: 验证 alloc 非法 shape/stride 抛 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_alloc_invalid_shape_or_stride
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_alloc_invalid_dtype_or_space
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_free_returns_none
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# TC-OP-DMA-AF-005
# 测试目的: 验证 free 非 Memory 输入抛 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_free_type_error
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_copy_success
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# TC-OP-DMA-002
# 测试目的: 验证 copy 输入类型错误触发 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_copy_type_error
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
def test_copy_type_error() -> None:
    ...
    with pytest.raises(KernelCodeError, match="MemorySpace"):
        copy(src, "SM")


# TC-OP-DMA-010
# 测试目的: 验证 copy 继承 source 的 shape/stride/format 规格。
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_copy_preserves_spec
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_cast_changes_dtype
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_cast_overrides_space
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# TC-OP-DMA-012
# 测试目的: 验证 cast 非法 dtype 或 memoryspace 触发 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_cast_invalid_dtype
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_cast_numeric_conversion_supported
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_cast_supported_conversions
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_reshape_returns_memory
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_reshape_default_stride_contiguous
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_reshape_invalid_shape_or_stride
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
def test_reshape_invalid_shape_or_stride() -> None:
    ...
    with pytest.raises(KernelCodeError, match="numel"):
        reshape(src, shape=[5, 5])
    non_contiguous = Memory([2, 3, 4], NumericType.Float32, stride=[100, 4, 1])
    with pytest.raises(KernelCodeError, match="contiguous"):
        reshape(non_contiguous, shape=[6, 4])


# TC-OP-DMA-017
# 测试目的: 验证 flatten 在连续布局下返回一维 shape 与 stride=[1]。
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_flatten_contiguous
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
...
# 使用示例: pytest -q test/operation/test_dma_alloc_lifecycle.py -k test_flatten_non_contiguous_rejected
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_alloc_lifecycle.py
