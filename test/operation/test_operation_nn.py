...
# 使用示例: pytest -q test/operation/test_operation_nn.py -k test_nn_facade_hides_private_helpers
...
# 使用示例: pytest -q test/operation/test_operation_nn.py -k test_nn_facade_public_objects_available
# 对应功能实现文件路径: kernel_gen/operation/nn/__init__.py
# 对应 spec 文件路径: spec/operation/nn.md
# 对应测试文件路径: test/operation/test_operation_nn.py
