...
使用示例:
- pytest -q test/operation/test_package.py
...
# 使用示例: pytest -q test/operation/test_package.py -k test_operation_explicit_import_exposes_only_public_exports
# 对应功能实现文件路径: kernel_gen/operation/__init__.py
...
# 使用示例: pytest -q test/operation/test_package.py -k test_operation_top_level_namespace_does_not_export_arch_or_extended_nn_helpers
# 对应功能实现文件路径: kernel_gen/operation/__init__.py
...
# 使用示例: pytest -q test/operation/test_package.py -k test_operation_package_top_level_imports
# 对应功能实现文件路径: kernel_gen/operation/__init__.py
# 对应 spec 文件路径: spec/operation/nn.md, spec/operation/dma.md, spec/operation/scf.md
# 对应测试文件路径: test/operation/test_package.py
...
# 使用示例: pytest -q test/operation/test_package.py -k test_operation_package_export_identity
# 对应功能实现文件路径: kernel_gen/operation/__init__.py
# 对应 spec 文件路径: spec/operation/nn.md, spec/operation/dma.md, spec/operation/scf.md
# 对应测试文件路径: test/operation/test_package.py
