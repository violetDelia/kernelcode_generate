...
使用示例:
- pytest -q test/operation/test_dma_transfer_view.py

关联文件:
- 功能实现: kernel_gen/operation/dma.py
- Spec 文档: spec/operation/dma.md
- 测试文件: test/operation/test_dma_transfer_view.py
"""
...
ShapeNormalizer = Callable[[ShapeInput, str], SymbolShape]


# TC-OP-DMA-003
# 测试目的: 验证 load 返回结果块并切换到目标空间。
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_load_result_space
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# TC-OP-DMA-023
# 测试目的: 验证 load 的 space 类型错误触发 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_load_invalid_space_type
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_slice_result_shape
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_store_size_mismatch
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# TC-OP-DMA-025
# 测试目的: 验证 store/deslice dtype mismatch 触发 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_store_dtype_mismatch
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_store_success
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_deslice_size_mismatch
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_dma_index_rank_mismatch
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
def test_dma_index_rank_mismatch() -> None:
    src = Memory(["M", "N"], NumericType.Float32)
    with pytest.raises(KernelCodeError, match="rank"):
...
# TC-OP-DMA-024
# 测试目的: 验证 sizes 中非正长度触发 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_dma_invalid_sizes
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
def test_dma_invalid_sizes() -> None:
    src = Memory(["M", "N"], NumericType.Float32)
    with pytest.raises(KernelCodeError, match="size"):
        load(src, offsets=[0, 0], sizes=[0, 1], strides=[1, 1])


# TC-OP-DMA-008
# 测试目的: 验证非单位 stride 允许使用且执行边界校验。
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_dma_non_unit_stride_checked
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
def test_dma_non_unit_stride_checked() -> None:
    ...
    with pytest.raises(KernelCodeError, match="out of bounds"):
        load(src, offsets=[0, 12], sizes=[2, 4], strides=[1, 2])


# TC-OP-DMA-009
# 测试目的: 验证非 Memory 输入触发 KernelCodeError。
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_dma_type_error
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_view_subview_returns_memory
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_view_inherits_source_memoryspec
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_view_bounds_check
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_view_invalid_offset_size_stride
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
...
# 使用示例: pytest -q test/operation/test_dma_transfer_view.py -k test_dma_access_region_helpers_share_unified_validation_entry
# 对应功能实现文件路径: kernel_gen/operation/dma.py
# 对应 spec 文件路径: spec/operation/dma.md
# 对应测试文件路径: test/operation/test_dma_transfer_view.py
def test_dma_access_region_helpers_share_unified_validation_entry(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def fake_normalize_and_validate_access_region(
        memory: Memory,
        *,
        offsets: SymbolShape | list[int] | tuple[int, ...],
        sizes: SymbolShape | list[int] | tuple[int, ...],
        strides: SymbolShape | list[int] | tuple[int, ...] | None = None,
        offset_name: str = "offsets",
        size_name: str = "sizes",
        stride_name: str = "strides",
        offset_normalizer: ShapeNormalizer | None = None,
        size_normalizer: ShapeNormalizer | None = None,
        stride_normalizer: ShapeNormalizer | None = None,
