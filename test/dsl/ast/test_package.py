...
覆盖率信息:
- 覆盖率命令: coverage run -m pytest -q test/dsl/ast/test_package.py && coverage report --include=kernel_gen/dsl/ast/__init__.py -m
- 覆盖率结果: 未统计（待补充）
- 达标线: 95%
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_get_block_id_arity_variants
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_get_block_num_arity_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_get_subthread_id_arity_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_get_thread_id_arity_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_supports_memory_get_shape_index
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_supports_memory_get_stride_index
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_get_subthread_num_arity_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_unimported_dma_helpers
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_dma_helper_call_via_attribute_chain
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_spoofed_import_bound_helper_object
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/mlir_gen.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_non_whitelisted_local_import_without_side_effect
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_import_after_return
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_visit_function_builds_ast
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_ast_parse_function_parses_annotations
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_ast_parse_function_accepts_tensor_bool_annotations
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_ast_parse_function_missing_annotation_reports_diagnostics
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_entry
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_preserves_explicit_return_without_return_annotation
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_does_not_depend_on_ast_visitor_entry
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_globals_and_builtins_annotation_entry
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_unknown_name_reports_diagnostics
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_invalid_return_annotation_reports_diagnostics
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_missing_return_reports_diagnostics
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_missing_tensor_dimensions_reports_diagnostics
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_infers_symboldim_arguments_without_annotations
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_infers_bool_runtime_arguments_without_annotations
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_float_runtime_arguments_without_annotations
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_supports_tensor_i1_return_annotation
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_unsupported_nn_arithmetic_arity_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_ast_parse_function_supports_symbol_scalar_and_joinedstr_annotations
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_ast_accepts_float_return_annotation_for_symbol_to_float
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_ast_rejects_non_float_annotation_for_symbol_to_float
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_load_helper_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_slice_helper_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_copy_helper_space
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_cast_helper_parameters
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_store_helper_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_deslice_helper_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_unsupported_syntax_reports_diagnostics
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_parses_arch_barrier_statement
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_arch_barrier_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_parses_arch_launch_kernel_with_callee
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
...
# 使用示例: pytest -q test/dsl/ast/test_package.py -k test_parse_function_rejects_invalid_arch_launch_kernel_variants
# 对应功能实现文件路径: kernel_gen/dsl/ast/__init__.py
# 对应 spec 文件路径: spec/dsl/ast/__init__.md
# 对应测试文件路径: test/dsl/ast/test_package.py
