...
使用示例:
- pytest -q test/symbol_variable/test_package.py
...
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_python_symbol_variable_imports
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
...
# PM-002
# 功能说明: 验证旧路径不再可用。
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_legacy_import_disabled
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
...
# PM-003
# 功能说明: 验证旧子模块路径不可导入。
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_legacy_submodule_import_disabled
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
...
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_python_package_type_exports
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
...
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_package_type_construct_memory
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
...
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_python_package_exports_match_public_contract
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
...
# 使用示例: pytest -q test/symbol_variable/test_package.py -k test_python_package_import_star_exports_only_public_names
# 对应功能实现文件路径: kernel_gen/symbol_variable/__init__.py
# 对应 spec 文件路径: spec/symbol_variable/package_api.md
# 对应测试文件路径: test/symbol_variable/test_package.py
