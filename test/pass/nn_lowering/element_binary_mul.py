...
- 测试文件: test/pass/nn_lowering/element_binary_mul.py
"""
...
# 使用示例: pytest -q test/pass/nn_lowering/element_binary_mul.py -k test_lower_mul_to_kernel_binary_elewise
...
# 对应测试文件路径: test/pass/nn_lowering/element_binary_mul.py
