...
- 测试文件: test/pass/nn_lowering/element_compare_lt.py
"""
...
# 使用示例: pytest -q test/pass/nn_lowering/element_compare_lt.py -k test_lower_lt_to_kernel_binary_elewise
...
# 对应测试文件路径: test/pass/nn_lowering/element_compare_lt.py
